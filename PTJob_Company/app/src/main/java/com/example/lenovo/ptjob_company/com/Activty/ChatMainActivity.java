...
import com.example.lenovo.ptjob_company.com.Fragment.ContactsFragment;
...
public class ChatMainActivity extends FragmentActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
...
//    private ImageView mPlus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        App.ID = getIntent().getStringExtra("id");
...
//        mPlus.setOnClickListener(this);
     ...
     */
    private void init() {
//        mPlus = (ImageView) findViewById(R.id.id_communication_plus);
        mPager = (ViewPager) findViewById(R.id.id_communication_pager);
        mContactsTV = (TextView) findViewById(R.id.id_communication_contacts);
        mNewsTV = (TextView) findViewById(R.id.id_communication_news);
        mContactsIndicator = (ImageView) findViewById(R.id.id_bar_indicator_blow_contacts);
        mNewsIndicator = (ImageView) findViewById(R.id.id_bar_indicator_blow_news);

        mFragmentList = new ArrayList<>();
        mFragmentList.add(new MessageFragment());
        mFragmentList.add(new ContactsFragment());

        ((App) getApplication()).restoreData();
    }
...
//                Log.i("tag", "onClick: communication");
                ...
                if (request != null) {
                    ...
                    switch (status) {
                        ...
                        case Action.DELETE:
                            ...
                            //删除好友聊天记录
                            DAO.deleteFriends(ChatMainActivity.this, App.ID, friendId);
                            Toast.makeText(ChatMainActivity.this,"好友将你删除",Toast.LENGTH_SHORT).show();
                            break;
                    }
    ...
    protected void onDestroy() {
        ...
        setOffline();
        //保存数据
        DAO.saveContacts(ChatMainActivity.this, App.mContacts);
        DAO.saveChatRecords(ChatMainActivity.this, App.mChatRecordsMap);
