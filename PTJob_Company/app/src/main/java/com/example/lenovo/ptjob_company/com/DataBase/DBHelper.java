...
//    private static final String CREATE_P_TABLE ="create table "+ T_PLURALIST +
...
//            "(pluralist_id varchar(10) primary key,info_id varchar(10),status varchar(10))";
    ...
    private static final String CREATE_F_TABLE ="create table if not exists "+ T_FRIEND +
            "(id integer primary key autoincrement ,my_id varchar(10) not null,friend_id varchar(10) not null,friend_name varchar(10),image_name varchar(50))";
