...
public class ChangePasswordThread extends Thread{
    ...
    Message msg;
    public ChangePasswordThread(  String url, String phone,
            String oldpassword, String newpassword,Handler handler){
        this.url=url;
        this.phone=phone;
    ...
    public void doGet(){
        ...
        try {
            ...
            url =url+"?phone="+ phone+"&oldpassword=" + URLEncoder.encode(oldpassword, "utf-8") +
