...
/**
 * 网络加载类 Created by Administrator on 2016/8/1.
 */
public class HttpURLTask extends Thread {
	...
	public HttpURLTask(String url, HashMap<String, String> params,
			Handler handler) {
	...
	public HttpURLTask(String url, String method,
			HashMap<String, String> paramsMap, Handler handler) {
	...
	private void httpURLPostConnection(String mURL, String params,
			Handler mHandler) {
			...
			while (iterator.hasNext()) {
				...
				try {
					if (first) {
						...
						urlSB.append(request).append("=")
								.append(URLEncoder.encode(result, "utf-8"));
						first = false;
					} else {
						urlSB.append("&");
						urlSB.append(request).append("=")
